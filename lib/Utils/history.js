...
const downloadHistory = async (msg, options) => {
    ...
    if (msg.initialHistBootstrapInlinePayload) {
        buffer = typeof msg.initialHistBootstrapInlinePayload === 'string'
            ? Buffer.from(msg.initialHistBootstrapInlinePayload, 'base64')
            : Buffer.from(msg.initialHistBootstrapInlinePayload);
    } else {
