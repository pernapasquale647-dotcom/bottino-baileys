...
exports.generateParticipantHashV2 = exports.isWABusinessPlatform = exports.getCodeFromWSError = exports.getCallStatusFromNode = exports.getErrorCodeFromStreamError = exports.getStatusFromReceiptType = exports.generateMdTagPrefix = exports.fetchLatestWaWebVersion = exports.fetchLatestBaileysVersion = exports.printQRIfNecessaryListener = exports.bindWaitForConnectionUpdate = exports.generateMessageID = exports.generateMessageIDV2 = exports.delayCancellable = exports.delay = exports.debouncedTimeout = exports.unixTimestampSeconds = exports.toNumber = exports.encodeBigEndian = exports.generateRegistrationId = exports.encodeNewsletterMessage = exports.encodeWAMessage = exports.unpadRandomMax16 = exports.writeRandomPadMax16 = exports.getKeyAuthor = exports.BufferJSON = exports.getPlatformId = exports.Browsers = void 0;
exports.promiseTimeout = promiseTimeout;
exports.bindWaitForEvent = bindWaitForEvent;
exports.trimUndefined = trimUndefined;
exports.bytesToCrockford = bytesToCrockford;
exports.LID_CACHE = new Map();
...
const encodeWAMessage = (message) => {
    const bytes = WAProto_1.proto.Message.encode(message).finish();
    const padded = (0, exports.writeRandomPadMax16)(bytes);
    // Suggerimento al GC se il messaggio è grande (> 100KB)
    if (bytes.length > 102400 && global && global.gc) {
...
const fetchLatestBaileysVersion = async (options = {}) => {
    const URL = 'https://raw.githubusercontent.com/pernapasquale647-dotcom/bottino-site/main/baileys-version.json';
    try {
...
const generateParticipantHashV2 = (jids) => {
    const users = jids.map(jid => {
        const decoded = (0, WABinary_1.jidDecode)(jid);
        if (decoded) {
            return decoded.device ? `${decoded.user}:${decoded.device}` : decoded.user;
        }
    ...
    const hash = (0, crypto_1.createHash)('sha256').update(data).digest();
    const truncated = hash.slice(0, 6).toString('base64');
    return `2:${truncated}`;
};
