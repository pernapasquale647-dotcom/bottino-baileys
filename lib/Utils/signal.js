...
exports.extractE2ESessionFromRetryReceipt = exports.getNextPreKeysNode = exports.getNextPreKeys = exports.extractDeviceJids = exports.parseAndInjectE2ESessions = exports.xmppPreKey = exports.xmppSignedPreKey = exports.generateOrGetPreKeys = exports.getPreKeys = exports.createSignalIdentity = void 0;
...
const extractE2ESessionFromRetryReceipt = (receipt) => {
    ...
    if (!signedPubKey || signedPubKey.length !== 32 || !signedSig || typeof signedKeyId !== 'number' || !Number.isInteger(signedKeyId)) {
        return null;
    }
    ...
    if (preKeyNode) {
        ...
        if (!preKeyPub || preKeyPub.length !== 32 || typeof preKeyId !== 'number' || !Number.isInteger(preKeyId)) {
            return null;
        }
