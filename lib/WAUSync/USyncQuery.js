        ...
        const cacheLidMappings = (list) => {
            ...
            for (const item of list) {
                ...
                if (jid && lid && jid !== lid) {
                    ...
                    const normalizedLid = (0, WABinary_1.jidNormalizedUser)(lid);
                    if ((0, WABinary_1.isLidUser)(normalizedLid) && (0, WABinary_1.isJidUser)(normalizedJid)) {
                        WABinary_1.sharedLidPhoneCache?.set(normalizedLid, normalizedJid);
                    } else if ((0, WABinary_1.isLidUser)(normalizedJid) && (0, WABinary_1.isJidUser)(normalizedLid)) {
                        WABinary_1.sharedLidPhoneCache?.set(normalizedJid, normalizedLid);
                    }
                }
            }
        };
        cacheLidMappings(queryResult.list);
        cacheLidMappings(queryResult.sideList);
