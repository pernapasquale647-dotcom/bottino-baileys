...
class WebSocketClient extends types_1.AbstractSocketClient {
    constructor() {
        ...
        this._minSendIntervalMs = typeof this.config.minSendIntervalMs === 'number' ? this.config.minSendIntervalMs : ((Defaults_1.DEFAULT_CONNECTION_CONFIG && Defaults_1.DEFAULT_CONNECTION_CONFIG.minSendIntervalMs) || 50);
    }
    get isOpen() {
        var _a;
    ...
    async connect() {
        var _a, _b;
        if (this.socket) {
            if (this.isClosed || this.isClosing || this.isConnecting) {
